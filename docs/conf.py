...
# The short X.Y version.
# version = fanslicer.__version__
# The full version, including alpha/beta/rc tags.
# release = fanslicer.__version__
...
htmlhelp_basename = 'fanslicerdoc'
...
latex_documents = [
    ('index', 'fanslicer.tex',
     u'fanslicer Documentation',
     u'João Ramalhinho', 'manual'),
]
