...
# -*- coding: utf-8 -*-
#
# susi documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under susi
...
# The short X.Y version.
# version = susi.__version__
# The full version, including alpha/beta/rc tags.
# release = susi.__version__
...
latex_documents = [
    ('index', 'susi.tex',
     u'susi Documentation',
     u'Ester Bonmati', 'manual'),
]
